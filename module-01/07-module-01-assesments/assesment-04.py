...
print(
    f"Great! Here are the results of the basic math operations between the numbers you chose, {first_users_number} and {second_users_number}")
print(
